...
tv = TfidfVectorizer(use_idf = True, norm = 'l2')
...
gatherClassificationMetrics(test_sentiments, svm.predict((tv_test_features)))


# classifying using Logistic Regression
clf = LogisticRegression(random_state=0).fit(tv_train_features, train_sentiments)
